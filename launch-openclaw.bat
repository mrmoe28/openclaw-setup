...
echo [1/5] Cleaning stale lock files...
...
echo.
echo [4/5] Tunnel URL found! Updating config...
powershell -Command ^
...
start "OpenClaw Gateway" cmd /k "title OpenClaw Gateway && color 0E && echo Starting OpenClaw Gateway on port 18789... && echo Voice webhook on port 3334 && echo. && openclaw gateway"
